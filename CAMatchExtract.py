...
def CAMatchExtract(
    ...
    try:
        ...
        functions.highlight_and_click(page, accountName_link)
        page.wait_for_timeout(5000)  # wait 5 seconds
        dropdown_button = page.locator("iframe[name=\"main\"]").content_frame.locator("#ctl00_phG_PXSplitContainer_grid1_at_tlb_ul > li:nth-child(14)")
        ...
        save_path = os.getenv("SAVE_DIRECTORY") + download.suggested_filename
        ...
        functions.log_message(webhook_url, f"✅ Bank Charges Extracted: {save_path}")
        context.close()
        browser.close()
        ...
        reply_to_trigger_email("✅ CAMatch process completed successfully.")
        ...
        reply_to_trigger_email("CAMatch process failed.")
        raise
